...
class AnearEvent extends JsonApiResource {
  ...
  get anearEventMachine() {
    return this._anearEventMachine
  }

  set anearEventMachine(val) {
    this._anearEventMachine = val
  }

  announceEvent() {
    logger.debug("sending ANNOUNCE to anearEventMachine")
    this.anearEventMachine.send("ANNOUNCE")
  }

  startEvent() {
    this.anearEventMachine.send("START")
  }

  cancelEvent() {
    this.anearEventMachine.send("CANCEL")
  }

  closeEvent() {
    this.anearEventMachine.send("CLOSE")
  }

  pauseEvent() {
    this.anearEventMachine.send("PAUSE")
  }

  resumeEvent() {
    this.anearEventMachine.send("RESUME")
  }
