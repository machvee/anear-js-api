...
class AnearEvent extends JsonApiResource {
  ...
  announceEvent() {
    this.machineRef.send("ANNOUNCE")
  }

  startEvent() {
    this.machineRef.send("START")
  }

  cancelEvent() {
    this.machineRef.send("CANCEL")
  }

  closeEvent() {
    this.machineRef.send("CLOSE")
  }

  pauseEvent() {
    this.machineRef.send("PAUSE")
  }

  resumeEvent() {
    this.machineRef.send("RESUME")
  }
