...
class AnearEvent extends JsonApiResource {
  ...
  constructor(json, messaging) {
    ...
    this.anearStateMachine = this.initStateMachine(json.previousState, json.stateMachineContext)
  }
  ...
  toJSON() {
    return {
      ...
      stateMachineContext: this.anearStateMachine.context
    }
  }
  ...
  initStateMachine(previousState, stateMachineContext) {
  ...
  participantAction(anearParticipant, actionEventName, actionPayload) {
    this.anearStateMachine.sendActionEvent(actionEventName, {anearParticipant, payload: actionPayload})
  }
