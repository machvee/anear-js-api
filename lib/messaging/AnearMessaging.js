...
class AnearMessaging {
  ...
  publishEventParticipantsMessage(eventId, message, callback, timeoutMilliseconds=0) {
  ...
  publishEventSpectatorsMessage(eventId, message, callback) {
  ...
  publishEventPrivateMessage(eventId, anearParticipantUserId, message, callback=null, timeoutMilliseconds=0) {
