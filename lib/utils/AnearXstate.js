...
class AnearXstate {
  constructor(machineConfig, machineOptions, previousState, anearEventContext) {
    ...
    // create the AnearEvent machine, and load a fixed name file app_state_machine.js, app_state_machine_config.js
    // or something to that effect.
    // The parent machine will launch the app_state_machine as a child.
    // The parent machine will keep the Anear API state transitions up to date
    // The child machine will get all ACTION messages, and have state handlers
    // for parent machine handled events like Participant Join, Participant exit, Cancel, etc.
