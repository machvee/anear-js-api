...
const MetaProcessing = (anearEvent) => {
  return (appEventMachineState) => {
    ...
    const appExecutionContext = (displayType, timeout = null) => (
      {
        app: appContext,
        meta: {
          state: appStateName,
    ...
    if (meta.participants) {
      ...
      const displayEvent = {
        viewPath,
        context: appExecutionContext('participants', timeout)
      }
    ...
    if (meta.participant) {
      ...
      const displayEvent = {
        viewPath,
        context: appExecutionContext('participant', timeout)
      }
      displayEvents.push(displayEvent)
    }
    ...
    if (meta.spectators) {
      ...
      const displayEvent = {
        viewPath,
        context: appExecutionContext('spectators')
      }
      displayEvents.push(displayEvent)
    }
