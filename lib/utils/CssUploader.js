...
class CSSUploader {
   ...
   * @param {AnearApi} anearApi - An instance of the AnearApi class.
   * @param {string} appId - The application ID.
   */
  constructor(cssDirPath, assetsBaseUrl, anearApi, appId) {
  ...
  async uploadCss() {
    try {
      ...
      const responseAttrs = await this.anearApi.getAppCssUploadUrl(this.appId, contentHash, fileSuffix)
