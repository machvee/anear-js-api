...
class ParticipantTimer {
  // usage:
  //   t = ParticipantTimer('123', id => console.log(`times up for ${id}`))
  //   t.start(30000)
  //   t.pause()
  //   t.resume()
  //   t.currentStatus() => {state: 'running', timeoutMsecs: 30000, timeRemaining: 12083}
  //   t.turnoff()
  //   t.reset()
  //   t.start(8000)
  //   (after 8 seconds) => times up for 123
  ...
  timerExpired() {
    ...
    this.state = Expired
    this.expireCallback(this.participantId)
  }
