...
const AnearParticipantMachineContext = (anearParticipant, geoLocation, anearEvent, realtimeMessaging) => ({
  realtimeMessaging,
  anearEvent,
  anearParticipant,
  geoLocation,
...
const AnearParticipantMachineFunctions = {
  ...
  services: {
    privateParticipantDisplay: (context, event) => context.privateChannel.publish(event.displayMessage)
  },
  guards: {
  }
}
...
const AnearParticipantMachine = (anearParticipant, geoLocation, { anearEvent, realtimeMessaging }) => {
