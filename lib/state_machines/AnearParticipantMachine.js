...
const AnearParticipantMachineContext = (anearParticipant, geoLocation, cssUrl, anearEvent, realtimeMessaging, appParticipantMachineFactory) => ({
  realtimeMessaging,
  anearEvent,
  anearParticipant,
  geoLocation,
...
const AnearParticipantMachine = (anearParticipant, geoLocation, { anearEvent, cssUrl, realtimeMessaging, appParticipantMachineFactory }) => {
