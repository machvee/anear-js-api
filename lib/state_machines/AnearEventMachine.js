...
const ActiveEventStatesConfig = {
  ...
  states: {
    ...
    announce: {
      ...
      // landing page, and can click to JOIN and trigger a
      // PARTICIPANT_ENTER.  Browser Refresh can also trigger
      // a PARTICIPANT_ENTER for an existing participant
      ...
      on: {
        ...
        PARTICIPANT_LEAVE: {
          ...
          actions: [
            (c, e) => logger.debug("PARTICIPANT_LEAVE presence received: ", e.data),
