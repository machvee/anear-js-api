...
const AnearEventMachineContext = (anearEvent, anearApi, cssUrl, pugTemplates, realtimeMessaging, appEventMachineFactory, appParticipantMachineFactory) => ({
  anearEvent,
  anearApi,
  cssUrl,
  pugTemplates,
...
const ActiveEventConfig = {
  ...
  on: {
    ...
    [constants.ParticipantEnterEventName]: {
    ...
    createActionsChannel: assign(
      {
        actionsChannel: context => context.realtimeMessaging.getChannel(
          ...
          context.anearEvent.anearEventMachine,
          {
            presencePrefix: constants.ParticipantPresencePrefix
          }
        )
      }
    ),
    ...
    createSpectatorsChannel: assign(
      {
        spectatorsChannel: context => context.realtimeMessaging.getChannel(
          ...
          context.anearEvent.anearEventMachine,
          {
            presencePrefix: constants.SpectatorPresencePrefix,
            presenceEvents: constants.SpectatorPresenceEvents
          }
        )
      }
    ),
