...
const AnearEventMachineContext = (anearEvent, realtimeMessaging, appEventMachine) => ({
  realtimeMessaging,
  anearEvent,
  ...
  appEventMachine,
  eventChildMachine: null // third-party app spawned child machine
})
...
const AnearEventMachineFunctions = anearEventMachine => ({
  actions: {
    ...
    createEventAppMachine: assign(
      {
        eventChildMachine: context => anearEventMachine.createEventAppMachine(context)
      }
    ),
...
class AnearEventMachine extends AnearBaseMachine {
  constructor(anearEvent, realtimeMessaging, appEventMachine) {
    super(
      AnearEventMachineConfig(anearEvent.id),
      AnearEventMachineFunctions,
      AnearEventMachineContext(anearEvent, realtimeMessaging, appEventMachine)
    )
    anearEvent.anearEventMachine = this
  }
  ...
  createEventAppMachine(context) {
    const appMachine = context.appEventMachine(context.anearEvent)
    return this.spawnChildService(appMachine)
  }
