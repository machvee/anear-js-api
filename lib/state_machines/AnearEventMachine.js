...
const ActiveEventGlobalEvents = {
  ...
  PARTICIPANT_MACHINE_EXIT: {
    // YOU ARE HERE.  We need to detach the private channel
    // before removing it from the context.participantPrivateChannels
    actions: [
...
const ActiveEventStatesConfig = {
  ...
  states: {
    registerCreator: {
      ...
      invoke: {
        ...
        onDone: {
          ...
          target: 'setupCreatorPrivateChannel'
        },
        onError: {
          target: '#failure'
        }
    ...
    setupCreatorPrivateChannel: {
      id: 'setupCreatorPrivateChannel',
      deferred: DeferredStates,
    ...
    announce: {
      ...
      states: {
        ...
        newParticipant: {
          ...
          invoke: {
            ...
            onDone: {
              ...
              target: '#setupParticipantPrivateChannel',
              internal: true
            },
            onError: {
              target: '#activeEvent.failure'
        ...
        setupParticipantPrivateChannel: {
          id: 'setupParticipantPrivateChannel',
          deferred: DeferredStates,
          entry: 'createPrivateChannel',
          invoke: {
            src: 'attachToPrivateChannel',
...
const AnearEventMachineFunctions = ({
  actions: {
    ...
    createPrivateChannel: assign((context, event) => {
      ...
      const privateChannel = RealtimeMessaging.getChannel(
        anearParticipant.privateChannelName,
        context.anearEvent,
        {},
        { anearParticipant }
      )
  ...
  services: {
      ...
      const processDisplayEvent = (context, displayEvent) => {
        ...
        const privateParticipantSend = participantMachine => {
          ...
          participantMachine.send(
            ...
            {
              ...displayEventPayload,
              privateChannel: context.participantPrivateChannels[anearParticipant.id]
            }
          )
        }
    ...
    attachToPrivateChannel: async (context, event) => {
      const participantId = event.data.anearParticipant.id
      RealtimeMessaging.attachTo(context.participantPrivateChannels[participantId])
    },
    detachChannels: async context => {
      ...
      channels.concat(Object.values(context.participantPrivateChannels))
