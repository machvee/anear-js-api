...
const AnearEventMachineContext = (anearEvent, anearApi, realtimeMessaging, appEventMachineFactory) => ({
  anearEvent,
  anearApi,
  ...AnearEventChannels,
    ...
    startNewParticipantMachine: assign(
      {
        participantMachines: (context, event) => {
          const anearParticipant = new AnearParticipant(event.data)
...
const AnearEventMachine = (anearEvent, { anearApi, realtimeMessaging, appEventMachineFactory }) => {
