...
const AnearEventMachineContext = (anearEvent, anearApi, pugTemplates, realtimeMessaging, appEventMachineFactory) => ({
  anearEvent,
  anearApi,
  pugTemplates,
  ...AnearEventChannels,
...
const AnearEventMachineFunctions = ({
  ...
  services: {
    publishParticipantsDisplay: (context, event) => context.participantsDisplayChannel.publish(event.displayMessage),
...
const AnearEventMachine = (anearEvent, { anearApi, pugTemplates, realtimeMessaging, appEventMachineFactory }) => {
