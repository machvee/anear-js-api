...
const AnearCoreServiceMachineContext = (appId, realtimeMessaging, appEventMachineFactory, appParticipantMachineFactory) => ({
  appId,
...
const AnearCoreServiceMachine = (appEventMachineFactory, appParticipantMachineFactory = null) => {
  ...
  const realtimeMessaging = new RealtimeMessaging(appId)
