    ...
    spawnNewEventMachine: assign(
      {
        anearEventMachines: (context, event) => {
          ...
          const eventMachine = coreServiceMachine.spawnNewEventMachine(context, anearEvent)
          return {
...
class AnearCoreServiceMachine extends AnearBaseMachine {
  constructor(appId, appEventMachine) {
    ...
    super(
      ...
      AnearCoreServiceMachineContext(appId, anearApi, appEventMachine)
    )
  }
